...
<!-- badges: start -->
![](https://img.shields.io/badge/colours-feathers-yellow.svg)
[![Github All Releases](https://img.shields.io/github/downloads/shandiya/feathers/total.svg)]()
<!-- badges: end -->
...
knitr::include_graphics("images/galah.png")
```  
